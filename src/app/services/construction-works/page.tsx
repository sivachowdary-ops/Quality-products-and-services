...
export default async function ConstructionWorksPage() {
  const subCategories = await Promise.all([
    getPexelsImage("house construction building site", "square"),
    getPexelsImage("building renovation modernization", "square"),
    getPexelsImage("masonry brickwork wall", "square"),
    getPexelsImage("plastering wall finishing", "square"),
    getPexelsImage("tiling floor tiles", "square"),
    getPexelsImage("painting roller wall", "square"),
    getPexelsImage("electrical wiring installation", "square"),
    getPexelsImage("plumbing pipes tools", "square"),
    getPexelsImage("false ceiling grid", "square"),
    getPexelsImage("boundary wall compound construction", "square"),
    getPexelsImage("concrete civil repairs", "square"),
    getPexelsImage("waterproofing wall roof", "square"),
  ]).then((images) => [
