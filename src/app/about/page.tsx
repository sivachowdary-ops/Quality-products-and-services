          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="text-[var(--color-text-on-light-muted)] space-y-4 leading-relaxed">
                ...
                <p>
                  Our foundation was built on a simple premise: provide reliable, top-tier products without compromising on quality or service. Over the years, we have grown into a comprehensive &ldquo;One-Stop Solution&rdquo; spanning fourteen core verticals: Fire Fighting Equipment, Safety Materials, Housekeeping & Sanitary Solutions, Stationery Solutions, Electrical Materials, Aluminium Ladders, Wire Nails, Nut & Bolts Fasteners, MS Binding Wire, Industrial Tools & Spares, and Construction Equipments & Tools on the products side — plus Construction Works, Interior Works, and Waterproofing Works as full-service execution offerings.
                </p>
                <p>
      ...
      <section className="py-16 md:py-24 bg-[var(--color-surface-white)] text-center">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <p className="text-[var(--color-text-on-light-muted)] text-lg mb-4">
            We supply our full product range — Fire Equipment, Safety Materials, Housekeeping & Sanitary Solutions, Stationery, Electrical Materials, Aluminium Ladders, Wire Nails, Nut & Bolts Fasteners, MS Binding Wire, Industrial Tools & Spares, and Construction Equipments & Tools — <strong className="text-[var(--color-text-on-light)]">across India</strong>.
          </p>
          <p className="text-[var(--color-text-on-light-muted)] text-lg mb-8">
            Our construction, interior, and waterproofing execution services are currently available across <strong className="text-[var(--color-text-on-light)]">Andhra Pradesh and Telangana</strong>.
          </p>
